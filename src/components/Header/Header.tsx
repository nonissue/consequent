      ...
      <div className="relative z-20 inset-0">
        <div className="max-w-3xl mx-auto flex px-6 py-2 sm:px-6 lg:px-8 lg:py-2 inset-0 ">
          <div className="relative flex items-center space-between w-full">
            <div className="flex-grow uppercase text-md sm:text-xl md:text-xl text-almostblack dark:text-gray-50">
              <Link href="/">
            ...
            <Link href="/docs">
              <a
                className="text-gray-400 transition-all duration-300 fill-current
                            hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-400"
              >
            ...
            <Link href="https://github.com/nonissue/consequent">
              <a aria-label="Link to source code for this site on github">
                <svg
                  ...
                  data-prefix="fab"
                  data-icon="github"
                  className="w-5 h-5 -mt-1 inline-block ml-2 text-gray-400 transition-colors duration-300 fill-current
                            hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-400 "
                  viewBox="0 0 496 512"
                  width="20"
                  height="20"
